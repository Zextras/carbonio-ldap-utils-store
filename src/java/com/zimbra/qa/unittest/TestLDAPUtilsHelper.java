 ...
 * Before running:
 * 
 * cp ~/p4/main/ZimbraSambaExtension/src/schema/samba.schema /opt/zextras/openldap/etc/openldap/schema/samba.schema
 * 
 * edit /opt/zextras/conf/slapd.conf
 * add:
 * include         "/opt/zextras/openldap/etc/openldap/schema/nis.schema"    (for posix account and grop)
 * include         "/opt/zextras/openldap/etc/openldap/schema/samba.schema"  (for samba domain)
 * 
 * then restart slapd
 * 
 */

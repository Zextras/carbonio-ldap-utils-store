        ...
        public void searchObjects(String query, String base, Visitor visitor)
            ...
            try {
                ...
                if (ZimbraLog.account.isDebugEnabled()) {
                    ZimbraLog.account.info("Search base DB probably does not exist in the DIT - ignoring exception", e);
                } else {
                    ZimbraLog.account.info(
                            "Search base DB probably does not exist in the DIT - ignoring exception (%s:%s)",
